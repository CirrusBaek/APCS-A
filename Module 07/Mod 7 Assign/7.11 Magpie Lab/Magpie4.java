...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "I want", 0) >= 0)
        {
            ...
            if (position1 >= 0 && findKeyword(statement, "you", position1) >= 0)
            {
    ...
    {
        String[] RESPONSES = {"Interesting, tell me more.","Hmmm.","Do you really think so?","You don't say.","And??","Elaborate Please"};
