...
public class StringExplorer
{
    ...
    public static void main(String[] args)
    {
        ...
        sample = " I like pizza. ";
        System.out.println(sample);//padded
        System.out.println(sample.trim());//removes spaces
        System.out.println(sample.length());
        System.out.println(sample.indexOf("i")); //returns int
        System.out.println(sample.indexOf("i",8)); //returns int
        System.out.println(sample.substring(2,5)); 
        System.out.println(sample.substring(2)); //returns string
        System.out.println(sample.compareTo("hello")); //returns int
        System.out.println(sample.replaceAll("z","k"));
